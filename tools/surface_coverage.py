...
NOT_A_CAPABILITY = {
    ...
    "storage": "accounts for disk use and clears rebuildable bytecode; no durable learning object changes",
    "GET /settings/storage": "on-demand disk accounting for the local workspace",
    "POST /settings/storage": "explicit cleanup of unchanged rebuildable bytecode, with no durable learning object mutation",
