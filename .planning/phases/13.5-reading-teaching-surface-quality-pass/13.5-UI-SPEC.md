...
preset: none
created: 2026-08-12
primary_input: ".planning/ROADMAP.md §Phase 13.5; browser session 2026-08-12; direct measurement of the vendored woff2 files"
...
# Phase 13.5 — UI Design Contract: the Reading & Teaching Surface Quality Pass
...
**Authority order.** `ROADMAP.md` Phase 13.5 criteria 1–6 → `PLANNING-DIRECTIVES.md` §4 (the five
...
contains. The runtime already owns all three. Phase 13.5 requires one route that exposes what the
...
network unplugged — `CLAUDE.md:57`'s "degrade, never block", which is Phase 13.5's §15 gate 5.
...
- The item payload contract, the canonical response shapes, the scorer, the parser, the evidence
  schema. Phase 13.5 touches presentation only.
...
| Destructive action | *(none)* | — | Phase 13.5 introduces no destructive or irreversible learner action. Inventing a confirmation would make a hint request feel like a transgression. |
...
1. **The two-column learning workspace.** `.planning/UI-SPEC.md` §3's desktop 2/3 + 1/3 shell does
   ...
   column in Phase 13.5.** Building it would put the ladder, the reader nav and the evidence drawer
...
**Approval:** pending Phase 13.5 UI verification
