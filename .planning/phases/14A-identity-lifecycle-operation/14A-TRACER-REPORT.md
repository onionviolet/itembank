...
| cancel response | 1k | 0.09 | ms | 3 | < 500 ms |
| peak traced Python memory (not process RSS) | 1k | 0.59 | MB | 3 | bounded by streaming (no fixed number) |
| first useful discovery result | 10k | 0.29 | ms | 3 | < 2000 ms on 10k |
| full inventory | 10k | 0.25 | s | 3 | < 60 s on 100k (measured here on 1k/10k only; see The 100k corpus section) |
