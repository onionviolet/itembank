...
# Re-taken a third time 2026-09-05, same command, after SHARED_CSS gained the
# bind panel's label/field grid, which the settings page embeds like every
# other surface. The pre-change value was
